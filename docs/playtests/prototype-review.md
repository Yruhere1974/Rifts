...
| Two-engine burst overwhelmed the mission                             | Goal tuned to 24, blind work costs five instability, and Operator priming reduced to +1. Exact reviewed Influence sequence is tested. No class-specific victory lock was introduced. |
...
| Operator could start with a hidden self-assistance target            | Recipient is derived to always be another specialist.                                                                                                                                |
