...
| ----------------------------- | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Dice allocation               | Allocate five rolled dice across six platform systems; fire a system with everything in it            | A die in a system counts one, or two at 4+. Matched faces double that system's output; three or more consecutive faces add the run's length. The Boom Gun doubles its dice but cannot fire unbraced, and the bracing die buys no output of its own. Assist, Acquire and Investigate stay pilot work: one loose die on the 3+/1+ thresholds. A die placed in Hold over keeps its face through the refill and counts against the new allotment.                                                                                                                                                                 |
| Card weaving                  | Build a chain that alternates Channel and Resonance, or hold cards back for a longer chain next round | Length pays 1, 3, 6, 10. Exploit Opening stands in for either side of a chain, or on its own assists for two after the relay is restored. A broken chain is refused before it is committed. A played card leaves the hand until the round refresh; a held card survives the deal and counts against it.                                                                                                                                                                                                                                                                                                       |
...
| Systems placement             | Commit four markers into distinct modules in a fixed row; build beside what already stands            | Each module can be occupied once per round. A placement gains +1 for each built module directly beside it in the row. Recover with a marker primes the next effect placement for +1 output. Movement preserves priming. Repeated placements are rejected even if markers remain. A held module stays built into the next round and costs one of that round's markers.                                                                                                                                                                                                                                         |
...
| ----------------- | ------------------- | -------------------- | -------------------------------------------------------------------------------------------------------------- |
| Dice allocation   | Sixth die           | Seventh die          | More simultaneous commitments, and a better chance of a matched set or a run; the 4+/3+ thresholds never move. |
| Card weaving      | Third Channel       | Third Resonance      | Longer chains. Because length pays superlinearly, each added card is worth more than the last.                 |
...
| Systems placement | Fifth marker        | Sixth marker         | A longer connected run across the seven modules; one placement per module is unchanged.                        |
